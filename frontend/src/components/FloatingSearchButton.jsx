...
export function FloatingSearchButton() {
  ...
  return (
    <button
      type="button"
      onClick={openSearch}
      className="fixed bottom-6 right-6 z-[60] flex cursor-pointer items-center gap-2 rounded-full border border-white/15 bg-white px-4 py-3 text-sm font-semibold text-black shadow-[0_12px_40px_rgba(0,0,0,0.45)] transition-transform hover:scale-[1.03] md:bottom-8 md:right-8 md:px-5"
